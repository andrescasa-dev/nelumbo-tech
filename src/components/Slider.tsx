...
function Slider({value, onValueChange, className}:  SliderProps) {
  return (
    <SliderRadix.Root
          ...
          className={cn("relative flex h-5 w-full select-none items-center rounded-full border border-primary-200", className)}
        >
          <SliderRadix.Track className="relative grow rounded-full h-full">
