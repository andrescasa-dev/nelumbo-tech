...
interface VisaProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
}

function Visa({ className, ...delegate }: VisaProps) {
  return (
    <svg
      className={className}
